...
function _clearEditor() {
  const area = document.getElementById('edit-canvas-area');
  if (area) area.innerHTML = '<div class="edit-empty-hint"><span>PDF EDITOR</span><strong>Chưa có trang được chọn</strong><small>Thêm một tệp PDF, sau đó chọn trang ở bảng bên trái để bắt đầu chỉnh sửa.</small></div>';
